...
| 2️⃣ | ดูภาพ — ควรเห็นแต่ดวงไฟบนพื้นมืด (ถ้าสว่างฟุ้ง กด **มืดลง**) / **ถ้าภาพกลับด้าน กด 🔄 กลับภาพกล้อง (แกน X/Y)** |
...
| อาการ | วิธีแก้ |
|---|---|
| ภาพสว่างฟุ้งขาว แยกดวงไม่ออก | กด **มืดลง** (ค่าต่ำ ~5) — **บน Windows ถ้าล็อกไม่ได้ ให้จัดห้องให้มืดลง** ให้เห็นแต่ดวงไฟ |
| ภาพกลับด้าน / สลับซ้ายขวาบนล่าง | กดปุ่ม **🔄 กลับภาพกล้อง** (แกน X หรือ แกน Y) บนหน้าเว็บ (ระบบจำให้อัตโนมัติ) |
